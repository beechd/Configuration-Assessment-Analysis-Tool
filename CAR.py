...
def buildOutput(applicationData, worksheets):
    worksheet = None
    ...
    for application in range(0, len(applicationData)):
        ...
        if applicationRank == 'Bronze':
            ...
            generateApplicationHeader(applicationName, applicationRank, worksheet, row_counts[0])
            row_counts[0] = row_counts[0] + 1
        elif applicationRank == 'Silver':
            worksheet = worksheets[1]
            generateApplicationHeader(applicationName, applicationRank, worksheet, row_counts[1])
            row_counts[1] = row_counts[1] + 1
        elif applicationRank == 'Gold':
            worksheet = worksheets[2]
            generateApplicationHeader(applicationName, applicationRank, worksheet, row_counts[2])
            row_counts[2] = row_counts[2] + 1
        elif applicationRank == 'Platinum':
            worksheet = worksheets[3]
            generateApplicationHeader(applicationName, applicationRank, worksheet, row_counts[3])
...
def generateHeaders():
    bronze_worksheet = workbook.add_worksheet('Bronze')
    silver_worksheet = workbook.add_worksheet('Silver')
    gold_worksheet = workbook.add_worksheet('Gold')
    plat_worksheet = workbook.add_worksheet('Platinum')
...
if __name__ == "__main__":
    ...
    buildOutput(applicationData, worksheets)
    workbook.close()
